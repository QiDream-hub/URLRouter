...
static int user_posts_handler(void *request, void *response) {
  (void)response;
  route_params_t *params = (route_params_t *)request;
...
static int settings_handler(void *request, void *response) {
  (void)request;
  (void)response;
...
static int search_handler(void *request, void *response) {
  (void)response;
  route_params_t *params = (route_params_t *)request;
...
static int api_version_handler(void *request, void *response) {
  (void)response;
  route_params_t *params = (route_params_t *)request;
...
static int file_handler(void *request, void *response) {
  (void)response;
  route_params_t *params = (route_params_t *)request;
  printf(">>> File Handler <<<\n");
...
static int date_log_handler(void *request, void *response) {
  (void)response;
  route_params_t *params = (route_params_t *)request;
...
static void test_route(router_t *router, http_method_t method, const char *url,
...
int main(void) {
  ...
  router_register(router, HTTP_GET, "/$'settings'", settings_handler, NULL);
  ...
  /* 注册文件路由 */
  router_register(router, HTTP_GET, "/$'files'/${'.'}$'.'${}", file_handler,
                  NULL);
